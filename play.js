...
function final_punct(){
	for(at=0;at<19;at++){
		for(bt=0;bt<19;bt++){
			...
			if((tab2[at][bt]==0&&tab[at][bt]==1)||tab2[at][bt]==11) f_img.setAttribute("src", "black.png");
			if((tab2[at][bt]==0&&tab[at][bt]==2)||tab2[at][bt]==12) f_img.setAttribute("src", "white.png");
			if(tab2[at][bt]==3) f_img.setAttribute("src", "bp.png"); if(tab2[at][bt]==4) f_img.setAttribute("src", "wp.png");
			if(tab2[at][bt]==5) f_img.setAttribute("src", "wd.png"); if(tab2[at][bt]==6) f_img.setAttribute("src", "bd.png");
...
function set(x_b,y_b,x_h,y_h){
	...
	if(turn==1) hov.setAttribute("src", "black.png"); else hov.setAttribute("src", "white.png");
}
		...
		for(j=0;j<19;j++){
			if(tab[i][j]==turn&&check_beat(i,j,1)==1){
				...
				if(diff==0){
					...
					if(turn==1)document.getElementById((i*100)+j).setAttribute("src", "black.png");
					if(turn==2)document.getElementById((i*100)+j).setAttribute("src", "white.png");
	...
	if((histor+por<1||por==0)&&histor!=0){
		...
		for(a=0;a<19;a++){
			for(b=0;b<19;b++){
				...
				if(tab[a][b]==1) re_img.setAttribute("src", "black.png");
				if(tab[a][b]==2) re_img.setAttribute("src", "white.png");
			}
		}
		if(res_ch==1){
			document.getElementById('download').style.pointerEvents="auto";
